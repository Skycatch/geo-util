# Code Quality Report  
Mon Sep 16 2019 07:10:14 GMT-0700 (PDT)  
...
✔ 10) [TMS format | x=83935 y=186155] should calculate the tile rectangle for the tile (1 ms)  
...
✔ 13) [TMS format | x=83935 y=186155] should calculate the tile rectangle for the tile even if xy are strings (1 ms)  
...
✔ 18) [XYZ format] TI - should calculate the bounding rectangle in degrees for a set of positions with a buffer applied (0 ms)  
✔ 19) [XYZ format] Koriyama - should calculate the bounding rectangle in degrees for a set of positions with NO buffer (1 ms)  
  
**tilePixelToPosition**  
✔ 20) should return the geographic x,y in radians for the given pixel of a 256x256 tile (1 ms)  
  
**tilePixelToNativePosition**  
✔ 21) should return the geographic x,y in latlon for the given pixel of a 256x256 tile (0 ms)  
  
**StereaUtil**  
  
**StereaUtil#getProj4**  
✔ 22) returns the proj4 string from lat/lon (1 ms)  
...
**UtmUtil#getZone**  
✔ 25) returns the UTM zone from lat/lon (1 ms)  
✔ 26) throws an error on invalid lat/lon (0 ms)  
  
**UtmUtil#getProj4**  
✔ 27) returns the proj4 string (1 ms)  
✔ 28) throws an error on invalid utm zone (0 ms)  
  
**UtmUtil#getCoord**  
✔ 29) returns the UTM coordinate (2 ms)  
✔ 30) returns the UTM coordinate of given zone (1 ms)  
