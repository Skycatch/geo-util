...
class GeographicTilingScheme {
   ...
   */
  toDegrees (r) {
    debug('toDegrees', r, (r * 180) / Math.PI)
  ...
  tileXYToRectangle (x, y, level, tmsY = false) {
    ...
    debug('tileXYToRectangle south', y, y + 1, width, rectangle.north)

    debug(
      'tileXYToRectangle rectangle radians',
      west,
      south,
      east,
      north,
